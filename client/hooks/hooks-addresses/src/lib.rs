...
pub struct Addresses {
    ...
    // SCBL .34 retail Storm/Echo diagnostic-only entry points.
    #[serde(default)]
    pub func_storm_join_admission_trace: Option<Address>,
    #[serde(default)]
    pub func_storm_session_lock_trace: Option<Address>,
    #[serde(default)]
    pub func_storm_session_unlock_trace: Option<Address>,

    // SCBL .38 retail DX11 assembly-proof diagnostic-only entry points.
    #[serde(default)]
    pub func_state_join_on_enter_trace: Option<Address>,
    #[serde(default)]
    pub func_join_session_rmc_trace: Option<Address>,

    // SCBL .39 retail DX11 StateJoin event/source proof entry points.
    #[serde(default)]
    pub func_join_completion_event_trace: Option<Address>,
    #[serde(default)]
    pub func_state_join_update_trace: Option<Address>,
    #[serde(default)]
    pub func_storm_session_snapshot_apply_trace: Option<Address>,

    // SCBL .41 retail DX11 RDV completion-bridge proof entry points.
    #[serde(default)]
    pub func_rdv_completion_router_trace: Option<Address>,
    #[serde(default)]
    pub func_rdv_route_filter_trace: Option<Address>,
    #[serde(default)]
    pub func_state_join_reset_trace: Option<Address>,

    // SCBL .42 event-source proof entry points.
    #[serde(default)]
    pub func_rdv_event_fanout_trace: Option<Address>,
    #[serde(default)]
    pub func_rdv_listener_factory_trace: Option<Address>,
}
...
fn dx9_addresses() -> HashMap<[u8; 32], Addresses> {
    ...
    let dx9_addrs = Addresses {
        ...
        func_storm_join_admission_trace: Some(0x00AF4C40),
        func_storm_session_lock_trace: Some(0x00B05370),
        func_storm_session_unlock_trace: Some(0x00B053F0),
        // DX9 addresses are intentionally left disabled until independently disassembled.
        func_state_join_on_enter_trace: None,
        func_join_session_rmc_trace: None,
        func_join_completion_event_trace: None,
        func_state_join_update_trace: None,
        func_storm_session_snapshot_apply_trace: None,
        func_rdv_completion_router_trace: None,
        func_rdv_route_filter_trace: None,
        func_state_join_reset_trace: None,
        func_rdv_event_fanout_trace: None,
        func_rdv_listener_factory_trace: None,
    };
...
fn dx11_addresses() -> HashMap<[u8; 32], Addresses> {
    ...
    let dx11_addrs = Addresses {
        ...
        func_storm_join_admission_trace: Some(0x00859CF0),
        func_storm_session_lock_trace: Some(0x0086A6A0),
        func_storm_session_unlock_trace: Some(0x0086A720),
        // Verified against retail DX11 SHA256 c6b9f330...659eb4bc.
        func_state_join_on_enter_trace: Some(0x0084DA70),
        func_join_session_rmc_trace: Some(0x022BE610),
        // Verified against retail DX11 SHA256 c6b9f330...659eb4bc.
        func_join_completion_event_trace: Some(0x007BDFB0),
        func_state_join_update_trace: Some(0x00836F90),
        func_storm_session_snapshot_apply_trace: Some(0x0086A1E0),
        // Verified against retail DX11 SHA256 c6b9f330...659eb4bc.
        func_rdv_completion_router_trace: Some(0x0077DA30),
        func_rdv_route_filter_trace: Some(0x0077DB80),
        func_state_join_reset_trace: Some(0x0077C6F0),
        // .43 disables the uncertain .42 upstream entry points. The
        // StateJoin completion bridge uses only the verified .39/.41 hooks.
        func_rdv_event_fanout_trace: None,
        func_rdv_listener_factory_trace: None,
    };
...
pub fn search_patterns(filepath: &Path) -> Result<Addresses, Error> {
    ...
    let mut addr = Addresses {
        ...
        func_storm_join_admission_trace: None,
        func_storm_session_lock_trace: None,
        func_storm_session_unlock_trace: None,
        func_state_join_on_enter_trace: None,
        func_join_session_rmc_trace: None,
        func_join_completion_event_trace: None,
        func_state_join_update_trace: None,
