...
#[repr(C)]
#[derive(Debug, Clone, Copy)]
pub struct UplayGameSession {
    pub id: u64,
    pub data: UplayDataBlob,
}
...
mod tests {
    ...
    #[test]
    fn uplay_game_session_layout_matches_r1_abi() {
        #[cfg(target_pointer_width = "32")]
        {
            assert_eq!(std::mem::size_of::<UplayDataBlob>(), 8);
            assert_eq!(std::mem::size_of::<UplayGameSession>(), 16);
            assert_eq!(std::mem::align_of::<UplayGameSession>(), 8);
        }
    }
